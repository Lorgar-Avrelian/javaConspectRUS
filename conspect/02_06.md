...
public static void main(String[] args) {
    final Generator generator = new Generator(1);
    final Runnable task0 = () -> IntStream.range(0, 5).forEach(i -> {
        try {
            System.out.println("Thread " + Thread.currentThread().getName() + " generates " + generator.generate());
            TimeUnit.SECONDS.sleep(1);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
        }
...
```text
Thread Thread-2 generates 2
Thread Thread-1 generates 1
Thread Thread-0 generates 3
Thread Thread-2 generates 4
Thread Thread-2 generates 7
Thread Thread-2 generates 8
Thread Thread-2 generates 9
Thread Thread-0 generates 6
Thread Thread-1 generates 5
Thread Thread-0 generates 10
Thread Thread-1 generates 11
Thread Thread-0 generates 12
Thread Thread-1 generates 13
Thread Thread-0 generates 14
Thread Thread-1 generates 15
```
...
```text
Thread Thread-2 generates 3
Thread Thread-0 generates 1
Thread Thread-1 generates 2
Thread Thread-0 generates 4
Thread Thread-2 generates 5
Thread Thread-0 generates 6
Thread Thread-2 generates 7
Thread Thread-0 generates 8
Thread Thread-2 generates 9
Thread Thread-0 generates 10
Thread Thread-2 generates 11
```
...
Thread Thread-2 generates 3
Thread Thread-0 generates 1
Thread Thread-1 generates 4
Thread Thread-0 generates 5
Thread Thread-2 generates 6
Thread Thread-1 generates 7
Thread Thread-1 generates 8
Thread Thread-0 generates 9
Thread Thread-2 generates 10
Thread Thread-0 generates 11
Thread Thread-1 generates 12
Thread Thread-2 generates 13
Thread Thread-0 generates 14
Thread Thread-2 generates 15
```
Пример 2:
