...
Condition часто используется совместно с блокировками `Lock`, например, `ReentrantLock`, для создания более сложных
сценариев синхронизации, чем это возможно с помощью ключевого слова $\textrm{\color{orange}synchronized}$.
