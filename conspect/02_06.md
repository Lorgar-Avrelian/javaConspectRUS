...
\color{magenta}[единицы времени]\color{white})}$
...
private static final class Topic<T> {
    ...
    public T read(ReadTask task) throws InterruptedException {
        ...
        try {
            while (queu.isEmpty()) {
                Date date = Date.from(Instant.now().plus(task.timeout, TimeUnit.SECONDS.toChronoUnit()));
...
Topic contains 1 messages: [Producer 3 - Message № 3]
Producer 1 writes message Producer 1 - Message № 1
Topic contains 2 messages: [Producer 3 - Message № 3, Producer 1 - Message № 1]
Producer 2 writes message Producer 2 - Message № 2
Topic contains 3 messages: [Producer 3 - Message № 3, Producer 1 - Message № 1, Producer 2 - Message № 2]
Consumer 3 read message Producer 3 - Message № 3
Topic contains 2 messages: [Producer 1 - Message № 1, Producer 2 - Message № 2]
Consumer 2 read message Producer 1 - Message № 1
Topic contains 1 messages: [Producer 2 - Message № 2]
Consumer 1 read message Producer 2 - Message № 2
Topic contains 0 messages: []
Producer 3 writes message Producer 3 - Message № 4
Topic contains 1 messages: [Producer 3 - Message № 4]
Producer 2 writes message Producer 2 - Message № 6
Topic contains 2 messages: [Producer 3 - Message № 4, Producer 2 - Message № 6]
Producer 1 writes message Producer 1 - Message № 5
Topic contains 3 messages: [Producer 3 - Message № 4, Producer 2 - Message № 6, Producer 1 - Message № 5]
Consumer 2 read message Producer 3 - Message № 4
Topic contains 2 messages: [Producer 2 - Message № 6, Producer 1 - Message № 5]
Consumer 3 read message Producer 2 - Message № 6
Topic contains 1 messages: [Producer 1 - Message № 5]
Producer 1 writes message Producer 1 - Message № 7
Topic contains 2 messages: [Producer 1 - Message № 5, Producer 1 - Message № 7]
Producer 2 writes message Producer 2 - Message № 8
Topic contains 3 messages: [Producer 1 - Message № 5, Producer 1 - Message № 7, Producer 2 - Message № 8]
Consumer 1 read message Producer 1 - Message № 5
Topic contains 2 messages: [Producer 1 - Message № 7, Producer 2 - Message № 8]
Producer 3 writes message Producer 3 - Message № 8
Topic contains 3 messages: [Producer 1 - Message № 7, Producer 2 - Message № 8, Producer 3 - Message № 8]
main finished work.
Topic contains 3 messages: [Producer 1 - Message № 7, Producer 2 - Message № 8, Producer 3 - Message № 8]
```
...
Во всех случаях, прежде чем данный метод сможет выполнить возврат, текущий поток должен повторно получить блокировку,
связанную с этим `Condition`.  
Когда поток возвращается, он гарантированно продолжит своё выполнение не смотря на наличие или отсутствие блокировки.  
