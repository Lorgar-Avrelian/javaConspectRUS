...
работать с блокировками более гибко. Реализации интерфейса `Lock` позволяют это сделать, позволяя получать и снимать 
блокировку в разных участках кода, а также получать и снимать несколько блокировок в любом порядке.
