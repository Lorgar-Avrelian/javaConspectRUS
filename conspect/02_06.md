...
Еще одно отличие `ReentrantLock` от блоков $\textrm{\color{orange}synchronized}$ - свойство _fair_. Блокировка с этим
свойством обеспечивает «справедливость» очереди: пришедший раньше поток захватывает объект раньше. Блок
