...
- _Project_ - это [система сборки](/conspect/02_10.md/#24-системы-сборки) для проекта;
...
Web-приложения _Spring_ строятся на базе архитектурного шаблона [_MVC_](/conspect/02_09.md/#23-mvc). В соответствии с
ним
