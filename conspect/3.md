...
|           `@Tag`           | позволяет документировать контроллер в _Swagger UI_                                                                                | `name`<br/><br/>`description`<br/> | отображаемое название контроллера<br/>отображаемое описание контроллера                                                                                     |                                       Желательна в _Swagger UI_                                        |
|                            |                                                                                                                                    |                                    |                                                                                                                                                             |                                                                                                        |
...
|    **Аннотация**    | **Назначение**                                                                                                                                                                                                                                                                           |                                                                  **Аргументы**                                                                   | **Назначение аргументов**                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |                                                                       **Примечание**                                                                        |
|:-------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------:|
|   `@ApiResponse`    | позволяет документировать возвращаемые методом ответы в _Swagger UI_                                                                                                                                                                                                                     |                                          `responseCode`<br/>`description`<br/><br/>`content`<br/><br/>                                           | строчное значение кода ответа<br/>краткое строчное описание ответа<br/>возвращаемый с ответом контент, задаваемый с помощью аннотации `@Content`                                                                                                                                                                                                                                                                                                                                                        |                                                                  Желательна в _Swagger UI_                                                                  |
