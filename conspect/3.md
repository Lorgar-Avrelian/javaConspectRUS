...
|    GreaterThan     |                      поиск данных, у которых значения в поле больше указанного                      |
|      LessThan      |                      поиск данных, у которых значения в поле меньше указанного                      |
|      Between       | поиск данных, у которых значения поля находятся между двух указанных значений `findByNameNotNull()` |
| IsNotNull, NotNull |                        поиск значений, у которых определенное поле не пустое                        |
|    IsNull, Null    |                         поиск значений, у которых определенное поле пустое                          |
|        Like        |                                    поиск по строгому совпадению                                     |
|      Contains      |                                         поиск по совпадению                                         |

Также можно составлять свои запросы с использованием аннотации `@Query`.
