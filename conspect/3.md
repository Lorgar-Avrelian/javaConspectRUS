...
|:-------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------:|
| [**Spring Boot**](/conspect/3.md/#32-spring-boot) | [**Spring Boot**](/conspect/3.md/#32-spring-boot)                                                                      |             [**Spring Boot**](/conspect/3.md/#32-spring-boot)             | [**Spring Boot**](/conspect/3.md/#32-spring-boot)                                                                                                                                             |                            [**Spring Boot**](/conspect/3.md/#32-spring-boot)                            |
...
Связность сущностей реализуется за счёт использования следующих аннотаций:
...
Кроме того, в дополнение к указанным выше аннотациям используется аннотация `@JoinColumn`.

> При использовании _Swagger UI_ аннотация `@JoinColumn` полностью заменяет аннотацию `@Column`.
