...
|:------------------------:|:-----------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------:|
|        `@Contact`        | позволяет указать контактную информацию о разработчике                                                                 |             `name`<br/>`email`<br/>`url`              | строка с указанием имени разработчика<br/>строка с указанием _email_ разработчика<br/>строка с указанием ссылки на сайт разработчика                                                          |                                        Желательна в _Swagger UI_                                        |
