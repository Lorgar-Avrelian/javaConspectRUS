...
|                               `@SpringBootTest`                               | позволяет запускать тесты на основе _Spring Boot_                                                                                  |        `webEnvironment`<br/><br/><br/>`properties`<br/><br/><br/><br/>        | тип web-среды, которую следует создать _Spring_ при проведении тестов (по умолчанию _SpringBootTest.WebEnvironment.MOCK_)<br/>свойства в форме `ключ = значение`, которые следует добавить в _Spring Environment_ перед запуском теста |                                                                                               |
