...
> [[Ссылка]](https://mvnrepository.com/artifact/org.mapstruct/mapstruct/1.6.2) на актуальную версию _Maven_ репозитория
> _MapStruct_.  
> [[Ссылка]](https://mvnrepository.com/artifact/org.mapstruct/mapstruct-processor/1.6.2) на актуальную версию _Maven_
