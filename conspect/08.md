...
> [[_оглавление_]](../README.md/#8-работа-с-файлами)
...
> [[_оглавление_]](../README.md/#81-потоки-данных)
...
### 8.1.1 Классы для работы с потоками данных
...
#### 8.1.1.1 Абстрактный класс InputStream
...
#### 8.1.1.2 Абстрактный класс OutputStream
...
#### 8.1.1.3 Абстрактный класс Reader
...
#### 8.1.1.4 Абстрактный класс Writer
...
### 8.1.2 Классы для работы с файлами

> [[_оглавление_]](../README.md/#81-потоки-данных)

#### 8.1.2.1 Интерфейс Path
...
> Для работы с содержимым файла применяются методы класса [_Files_](/conspect/08.md/#9122-класс-files).
...
> Для работы с путём к файлу применяются методы интерфейса [_Path_](/conspect/08.md/#8121-интерфейс-path).
...
> [[_оглавление_]](../README.md/#82-действия-с-файлами)
...
- создание (с использованием конструкции [_try-with-resources_](/conspect/02_03.md/#252-обработка-исключений)) входного
