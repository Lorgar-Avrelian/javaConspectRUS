...
> [[_оглавление_]](../README.md/#9-логирование-конфигурирование-и-рефакторинг-приложений)

## 9.1 Логирование

> [[_оглавление_]](../README.md/#91-логирование)
    ...
    <appender name="CONSOLE" class="ch.qos.logback.core.ConsoleAppender">
        ...
        <layout class="ch.qos.logback.classic.PatternLayout">
            <Pattern>
                ...
                <!--    %d{yyyy-MM-dd HH:mm:ss.SSS} %clr(${LOG_LEVEL_PATTERN:-%5p}) %magenta(${PID:- }) --- [%15.15t] %cyan(%-40.40logger{40}) : %msg %n  -->
            </Pattern>
        </layout>
    </appender>
...
<configuration>
    ...
    <Appenders>
        ...
        <Console name="CONSOLE" target="SYSTEM_OUT">
            <!--    Раскрашивание логов с помощью стандартной библиотеки                                   -->
            <PatternLayout pattern="%d{yyyy-MM-dd HH:mm:ss.SSS} %clr(${LOG_LEVEL_PATTERN:-%5p}) %magenta(${PID:- }) --- [%15.15t] %cyan(%-40.40logger{40}) : %msg %n"/>
        </Console>
        <!--    Настройка вывода логов в файл-->
        <!--    Задание названия файла для сохранения логов-->
...
> [[_оглавление_]](../README.md/#92-конфигурирование)
...
> [[_оглавление_]](../README.md/#93-рефакторинг)
