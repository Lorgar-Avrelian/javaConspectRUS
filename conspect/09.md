    ...
    <appender name="CONSOLE" class="ch.qos.logback.core.ConsoleAppender">
        ...
        <layout class="ch.qos.logback.classic.PatternLayout">
            <Pattern>
                ...
                <!--    %d{yyyy-MM-dd HH:mm:ss.SSS} %clr(${LOG_LEVEL_PATTERN:-%5p}) %magenta(${PID:- }) --- [%t] %cyan(%-40.40logger{40}) : %msg %n    -->
            </Pattern>
        </layout>
    </appender>
...
<configuration>
    ...
    <Appenders>
        ...
        <Console name="CONSOLE" target="SYSTEM_OUT">
            <!--    Раскрашивание логов с помощью стандартной библиотеки                                   -->
            <PatternLayout pattern="%d{yyyy-MM-dd HH:mm:ss.SSS} %clr(${LOG_LEVEL_PATTERN:-%5p}) %magenta(${PID:- }) --- [%t] %cyan(%-40.40logger{40}) : %msg %n"/>
        </Console>
        <!--    Настройка вывода логов в файл-->
        <!--    Задание названия файла для сохранения логов-->
