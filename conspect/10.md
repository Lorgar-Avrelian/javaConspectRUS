# 10 Логирование, конфигурирование, рефакторинг и кэширование приложений

> [[_оглавление_]](../README.md/#10-логирование-конфигурирование-рефакторинг-и-кэширование-приложений)
...
[**[3.1.1.2 Интерфейс ApplicationContext]**](/conspect/3.md/#3112-интерфейс-applicationcontext)). Для разных способов
...
- файл _application-{profile}.properties_ - содержит настройки, применяемые с помощью _Spring Boot Profiles_ (описан в
  разделе [**[3.7 Spring Boot Profiles]**](/conspect/3.md/#37-spring-boot-profiles));
- файл _application.properties_ - содержит настройки применяемые по умолчанию (описан в разделе
  [**[3.5 Файл application.properties]**](/conspect/3.md/#35-файл-applicationproperties)).
...
> [[_оглавление_]](../README.md/#104-кэширование)
