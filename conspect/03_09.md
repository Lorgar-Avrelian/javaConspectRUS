...
- подключить библиотеку [Liquibase](/conspect/08.md/#838-liquibase);
...
> <details><summary><b>[Примечание]</b></summary>
>
> При приведении к [третьей нормальной форме](/conspect/08.md/#835-нормализация-таблиц-баз-данных) возможно разбиение
