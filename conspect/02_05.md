...
сортировка, сопоставление, сведение и другие.

_Stream API_ - это инструмент для обработки коллекций и массивов с использованием функционального подхода. Он позволяет
фильтровать, преобразовывать и агрегировать данные, используя функции, такие как `map()`, `filter()`, `reduce()`.
...
- [лямбда-выражения](/conspect/02_05.md/#281-лямбда-выражения);
- [ссылки на методы](/conspect/02_05.md/#282-ссылки-на-методы).
