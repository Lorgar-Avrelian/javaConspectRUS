...
Функция `limit()` ограничивает _Stream_ по количеству элементов.  
Синтаксис функции выглядит следующим образом:

$\textrm{\color{white}...}$  
$\space\space\space\space\space\space\space\space\textrm{\color{white}.stream()}$  
$\space\space\space\space\space\space\space\space\textrm{\color{white}...}$  
$\space\space\space\space\space\space\space\space\textrm{\color{white}.limit(\color{orange}long 
\color{magenta}[количество элементов]\color{white})}$  
$\space\space\space\space\space\space\space\space\textrm{\color{white}...}$
