...
-----------------------------------------------------------------------------------------------------------------------
[***2.6 Коллекции***](/conspect/2.md/#26-коллекции)

> [**2.6.1 Класс Collection**](/conspect/2.md/#261-класс-collection)
-----------------------------------------------------------------------------------------------------------------------
...
5. [**Многомерный массив**](/conspect/1.md/#1422-инициализация-массива)
6. [**Наборный блок _case_ в конструкции _switch-case_**](/conspect/1.md/#1213-оператор-switch)
7. [**Перегрузка конструктора**](/conspect/1.md/#193-конструктор)
8. [**Передача изображения из директории**](/conspect/example_1.md/#пример-2)
9. [**Получение изображения в директорию**](/conspect/example_1.md/#пример-1)
10. [**Создание строки из массива байтов**](/conspect/1.md/#1542-массив-байтов)
11. [**Создание исключения (Exception)**](/conspect/2.md/#253-написание-своих-исключений)
12. [**Счётчик (_counter_) в классе**](/conspect/2.md/#222-наследование)
13. [**Тернарный оператор**](/conspect/1.md/#1214-тернарный-оператор)
14. [**Тестирование приёма-передачи изображения**](/conspect/example_1.md/#пример-3)
15. [**Фабричный метод создания бина**](/conspect/3.md/#313-dependency-injection)
16. [**Циклические зависимости бинов (BeanCurrentlyInCreationException)**](/conspect/3.md/#313-dependency-injection)
-----------------------------------------------------------------------------------------------------------------------