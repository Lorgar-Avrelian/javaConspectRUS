...
[**_1.1 Переменные_**](#11-переменные)  
...
[**_1.2 Условные операторы_**](#12-условные-операторы)  
[_1.2.1 Виды условных операторов в Java:_](#121-виды-условных-операторов-в-java)  
