...
> 
> > [_2.4.6.14 Методы для получения неизменяемых коллекций и карт_](/conspect/02_04.md/#24614-методы-для-получения-неизменяемых-коллекций-и-карт)  
> > [_2.4.6.15 Методы для получения синхронизированных коллекций и карт_](/conspect/02_04.md/#24615-методы-для-получения-синхронизированных-коллекций-и-карт)  
-----------------------------------------------------------------------------------------------------------------------
</details>
