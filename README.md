...
10. [**Счётчик (_counter_) в классе**](/conspect/2.md/#222-наследование)
11. [**Тернарный оператор**](/conspect/1.md/#1214-тернарный-оператор)
12. [**Тестирование приёма-передачи изображения**](/conspect/2.md/#252-обработка-исключений)
13. [**Фабричный метод создания бина**](/conspect/3.md/#313-dependency-injection)
14. [**Циклические зависимости бинов (BeanCurrentlyInCreationException)**](/conspect/3.md/#313-dependency-injection)
-----------------------------------------------------------------------------------------------------------------------