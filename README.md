...
> > [_2.5.3.2 Промежуточные (конвеерные) операции Stream_](/conspect/02_05.md/#2532-промежуточные-конвеерные-операции-stream)
...
>
> > [_2.5.3.3 Терминальные (конечные) операции Stream_](/conspect/02_05.md/#2533-терминальные-конечные-операции-stream)
