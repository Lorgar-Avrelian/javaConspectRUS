...
[1 **_Синтаксис языка_**](#1-синтаксис-языка)  
[1.1 **Переменные**](#11-переменные)  
[1.1.1 _Виды переменных_](#111-виды-переменных)  
[1.1.2 _Типизация переменных_](#112-типизация-переменных)  
[1.1.3 _Значения переменных по умолчанию_](#113-значения-переменных-по-умолчанию)  
[1.2 **Условные операторы**](#12-условные-операторы)  
[1.2.1 _Виды условных операторов в Java_](#121-виды-условных-операторов-в-java)  
