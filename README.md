...
__[1.1 Переменные](#11-переменные)  
_____[1.1.1 Виды переменных](#111-виды-переменных)  
_____[1.1.2 Типизация переменных](#112-типизация-переменных)  
_____[1.1.3 Значения переменных по умолчанию](#113-значения-переменных-по-умолчанию)  
__[1.2 Условные операторы](#12-условные-операторы)  
_____[1.2.1 Виды условных операторов в Java](#121-виды-условных-операторов-в-java)  
_______[1.2.1.1 Оператор if](#1211-оператор-if)  
_______[1.2.1.2 Оператор if-else](#1212-оператор-if-else)  
_______[1.2.1.3 Оператор switch](#1213-оператор-switch)  
_______[1.2.1.4 Тернарный оператор](#1214-тернарный-оператор)
