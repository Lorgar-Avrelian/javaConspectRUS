...
2. [**_StringBuilder_**](/conspect/1.md/#16-изменяемые-строки-stringbuilder)
3. [**_Utility_-класс / _private_-конструктор**](/conspect/1.md/#193-конструктор)
4. [**Многомерный массив**](/conspect/1.md/#1422-инициализация-массива)
5. [**Наборный блок _case_ в конструкции _switch-case_**](/conspect/1.md/#1213-оператор-switch)
6. [**Перегрузка конструктора**](/conspect/1.md/#193-конструктор)
7. [**Создание строки из массива байтов**](/conspect/1.md/#1542-массив-байтов)
8. [**Счётчик (_counter_) в классе**](/conspect/2.md/#222-наследование)
9. [**Тернарный оператор**](/conspect/1.md/#1214-тернарный-оператор)
