...
-----------------------------------------------------------------------------------------------------------------------
[***6 Инструменты разработчика***](/conspect/06.md/#7-инструменты-разработчика)
-----------------------------------------------------------------------------------------------------------------------

###### 6.1 Документирование

-----------------------------------------------------------------------------------------------------------------------
[***6.1 Документирование***](/conspect/06.md/#71-документирование)

> [**6.1.1 _Swagger_**](/conspect/06.md/#711-swagger)
> > [_6.1.1.1 Подключение **Swagger**_](/conspect/06.md/#7111-подключение-swagger)  
> > [_6.1.1.2 Документирование приложения_](/conspect/06.md/#7112-документирование-приложения)  
> > [_6.1.1.3 Документирование контроллеров_](/conspect/06.md/#7113-документирование-контроллеров)  
> > [_6.1.1.4 Документирование методов контроллера_](/conspect/06.md/#7114-документирование-методов-контроллера)  
> > [_6.1.1.5 Документирование параметров методов контроллера_](/conspect/06.md/#7115-документирование-параметров-методов-контроллера)  
> > [_6.1.1.6 Документирование сущностей_](/conspect/06.md/#7116-документирование-сущностей)  
> > [_6.1.1.7 Совместимость со **Spring Security**_](/conspect/06.md/#7117-совместимость-со-spring-security)

> [**6.1.2 JavaDoc**](/conspect/06.md/#712-javadoc)

> [**6.1.3 Wiki**](/conspect/06.md/#713-wiki)
> > [_6.1.3.1 Markdown_](/conspect/06.md/#7131-markdown)  
> > [_6.1.3.2 README.md_](/conspect/06.md/#7132-readmemd)
-----------------------------------------------------------------------------------------------------------------------

###### 6.2 Postman

-----------------------------------------------------------------------------------------------------------------------
[***6.2 Postman***](/conspect/06.md/#72-postman)

> [**6.2.1 Совместимость со _Spring Security_**](/conspect/06.md/#721-совместимость-со-spring-security)
-----------------------------------------------------------------------------------------------------------------------

###### 6.3 PostgreSQL

-----------------------------------------------------------------------------------------------------------------------
[***6.3 PostgreSQL***](/conspect/06.md/#73-postgresql)

> [**6.3.1 Добавление ролей пользователей**](/conspect/06.md/#731-добавление-ролей-пользователей)

> [**6.3.2 Создание базы данных**](/conspect/06.md/#732-создание-базы-данных)
-----------------------------------------------------------------------------------------------------------------------

###### 6.4 Git

-----------------------------------------------------------------------------------------------------------------------
[***6.4 Git***](/conspect/06.md/#74-git)
-----------------------------------------------------------------------------------------------------------------------

###### 6.5 Intellij IDEA

-----------------------------------------------------------------------------------------------------------------------
[***6.5 Intellij IDEA***](/conspect/06.md/#75-intellij-idea)

> [**6.5.1 Горячие клавиши**](/conspect/06.md/#751-горячие-клавиши)

> [**6.5.2 Debug**](/conspect/06.md/#752-debug)
-----------------------------------------------------------------------------------------------------------------------

###### 6.6 Agile

-----------------------------------------------------------------------------------------------------------------------
[***6.6 Agile***](/conspect/06.md/#76-agile)

> [**6.6.1 Методологии Agile**](/conspect/06.md/#761-методологии-agile)

> [**6.6.2 Scrum**](/conspect/06.md/#762-scrum)
-----------------------------------------------------------------------------------------------------------------------

###### 6.7 Преобразование кода

-----------------------------------------------------------------------------------------------------------------------
[***6.7 Преобразование кода***](/conspect/06.md/#77-преобразование-кода)

> [**6.7.1 MapStruct**](/conspect/06.md/#771-mapstruct)

> [**6.7.2 Lombok**](/conspect/06.md/#772-lombok)
> > [_6.7.2.1 @Getter и @Setter_](/conspect/06.md/#7721-getter-и-setter)  
> > [_6.7.2.2 @NoArgsConstructor, @RequiredArgsConstructor и @AllArgsConstructor_](/conspect/06.md/#7722-noargsconstructor-requiredargsconstructor-и-allargsconstructor)  
> > [_6.7.2.3 @ToString_](/conspect/06.md/#7723-tostring)  
> > [_6.7.2.4 @EqualsAndHashCode_](/conspect/06.md/#7724-equalsandhashcode)  
> > [_6.7.2.5 @NonNull_](/conspect/06.md/#7725-nonnull)  
> > [_6.7.2.6 @Data_](/conspect/06.md/#7726-data)  
> > [_6.7.2.7 @Value_](/conspect/06.md/#7727-value)  
> > [_6.7.2.8 @Cleanup_](/conspect/06.md/#7728-cleanup)  
> > [_6.7.2.9 @Synchronized_](/conspect/06.md/#7729-synchronized)  
> > [_6.7.2.10 @SneakyThrows_](/conspect/06.md/#77210-sneakythrows)  
> > [_6.7.2.11 @Builder_](/conspect/06.md/#77211-builder)  
> > [_6.7.2.12 @Log_](/conspect/06.md/#77212-log)
-----------------------------------------------------------------------------------------------------------------------
</details>

###### 8 Базы данных

<details><summary>8 Базы данных</summary>
...
<details><summary>9 Работа с файлами</summary>
