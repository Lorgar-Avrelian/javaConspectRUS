 ...
 * транзакционности.<br>
 * При возвращении объекта потоком в пул происходит его автоматическое "очищение", в процессе которого объект
 * возвращается в исходное состояние (состояние на момент извлечения из пула).<br><br>
 *
