...
class AuthorizationServiceImplTest {
    ...
    void login1() {
        ...
        assertDoesNotThrow(() -> authorizationService.login(OWNER_AUTH));
    ...
    void login2() {
        ...
        assertDoesNotThrow(() -> authorizationService.login(ADMIN_AUTH));
    }
    ...
    void login3() {
        ...
        assertNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.login(USER_AUTH));
    }
    ...
    void register1() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.register(OWNER_REGISTER));
        assertInstanceOf(Login.class, actualLogin);
        assertEquals(OWNER, actualLogin);
    }
    ...
    void register2() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.register(ADMIN_REGISTER));
        assertInstanceOf(Login.class, actualLogin);
    ...
    void register3() {
        ...
        assertNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.register(USER_REGISTER));
    }
    ...
    void register5() {
        ...
        assertNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.register(admin));
    }
    ...
    void getAllUsers1() {
        ...
        assertDoesNotThrow(() -> authorizationService.getAllUsers());
    ...
    void getAllUsers3() {
        ...
        assertNotNull(actualCollection);
        assertDoesNotThrow(() -> authorizationService.getAllUsers(page, size));
        assertInstanceOf(Collection.class, actualCollection);
        assertIterableEquals(LOGIN_DTO_LIST, actualCollection);
    }
    ...
    void setRole1() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.setRole(ADMIN_DETAILS, USER.getId(), Role.ROLE_USER));
    ...
    void setPassword1() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.setPassword(OWNER_DETAILS, USER.getId(), USER.getPassword()));
        assertInstanceOf(LoginDTO.class, actualLogin);
        assertEquals(USER_LOGIN_DTO, actualLogin);
    }
    ...
    void setPassword3() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.setPassword(USER_DETAILS, USER.getId(), USER.getPassword()));
        assertInstanceOf(LoginDTO.class, actualLogin);
        assertEquals(USER_LOGIN_DTO, actualLogin);
    }
    ...
    void delete1() {
        ...
        assertNotNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.delete(OWNER_DETAILS, USER.getId()));
        assertInstanceOf(LoginDTO.class, actualLogin);
        assertEquals(USER_LOGIN_DTO, actualLogin);
    }
    ...
    void delete4() {
        ...
        assertNull(actualLogin);
        assertDoesNotThrow(() -> authorizationService.delete(ADMIN_DETAILS, USER.getId()));
    }
}