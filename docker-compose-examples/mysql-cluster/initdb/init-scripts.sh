...
CREATE TABLE DATABASECHANGELOG (
  ...
  ORDEREXECUTED varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  EXECTYPE varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (ID, AUTHOR, FILENAME) USING BTREE
