...
class ManageServiceImplTest {
    ...
    void giveBookToReader1() {
        ...
        Assertions.assertDoesNotThrow(() -> manageService.giveBookToReader(BOOK_1.getId(), READER_1.getId()));
    ...
    void findReaderBooks1() {
        ...
        Assertions.assertDoesNotThrow(() -> manageService.findReaderBooks(READER_1.getId()));
    ...
    void takeBookFromReader1() {
        ...
        assertNotNull(actualReader);
        assertInstanceOf(Reader.class, actualReader);
        Assertions.assertDoesNotThrow(() -> manageService.takeBookFromReader(BOOK_1.getId(), READER_1.getId()));
        assertEquals(READER_1, actualReader);
    }
